...
const MATH_FORMAT_INSTRUCTION = 'Sempre escreva fórmulas matemáticas usando delimitadores LaTeX: use $$...$$ para fórmulas em bloco (display) e $...$ para fórmulas inline. Nunca use blocos de código (```), <pre>, <code> ou qualquer tag HTML para fórmulas matemáticas. Sempre que usar $$...$$, coloque a fórmula em uma nova linha, sem texto antes ou depois, para garantir que fique em destaque.';
const PROMPTS = {
