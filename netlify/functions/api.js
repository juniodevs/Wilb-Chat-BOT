...
const MATH_FORMAT_INSTRUCTION = 'Sempre escreva fórmulas matemáticas usando delimitadores KaTeX: utilize $$...$$ para fórmulas em bloco (display) e $...$ para fórmulas inline. Não use blocos de código (```), <pre>, <code> ou qualquer tag HTML para fórmulas matemáticas. Sempre que usar $$...$$, coloque a fórmula em uma nova linha, sem texto antes ou depois, para garantir que fique em destaque. Certifique-se de que a sintaxe seja compatível com KaTeX.';
const PROMPTS = {
...
// Se quiser rodar localmente, descomente abaixo:
